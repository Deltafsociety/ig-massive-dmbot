...
Instagram DIRECT MESSAGE bot with account switcher feature. This bot can send messages automatically in your list of usernames.
...
1.  Git clone this repo with this command --> `https://github.com/Deltafsociety/ig-massive-dmbot.git`
